  ...
  return (
    <section id="section-4" className="relative w-full">
      <div className="flex flex-col lg:block relative w-full h-auto lg:aspect-[2560/1600]">
        <div className="order-2 relative w-full overflow-hidden order-2 aspect-[1536/1600] lg:aspect-auto lg:absolute lg:inset-0 lg:h-auto lg:order-none">
        ...
        <div className="hidden lg:block pointer-events-auto absolute w-full h-full">
        ...
        <div className="lg:hidden pointer-events-auto absolute w-full h-full">
        <div className="absolute left-[47.5vw] top-[33.5vw] z-30 text-[#dc7156] tracking-wide font-semibold">
          <p className="text-[3.2vw] [-webkit-text-stroke:0.1vw_black]">
            GARAGE
          </p>
        </div>

        <div className="absolute top-[10vw] left-[5vw] w-[18vw] h-auto rotate-0.5 flex flex-col items-center px-[0.5vw] py-[1.2vw] text-center mix-blend-multiply">
          <h2 className="text-[#dc7156] wl-fs-40 font-mono font-black tracking-tighter leading-none mb-[0.5vw]">
            &gt;_ GARAGE.sh
          </h2>
          <div className="flex-1 w-full pl-[3vw] bg-white/40 p-[0.5vw] rounded-sm">
        ...
        <Link
          ...
          >
          <span className="text-[3.3vw] font-bold text-[#dc7156] block">
              Click me → Your robot awaits.
          </span>
        </Link>
        </div>
